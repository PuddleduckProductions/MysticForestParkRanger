...
/// <summary>
/// Controls the squash and stretch effect on a specified transform.
/// </summary>
public class SquashAndStretch : MonoBehaviour
{
    ...
    /// <summary>
    /// Coroutine that applies a squash and stretch effect to a transform.
    /// </summary>
    ...
    /// <summary>
    /// Sets up the SquashAndStretch component with the specified parameters.
    /// </summary>
    /// <param name="axis">The axis to affect.</param>
    /// <param name="time">The animation duration in seconds.</param>
    /// <param name="zeroMap">The initial scale value.</param>
    /// <param name="oneMap">The maximum scale value.</param>
    /// <param name="curve">The animation curve to use.</param>
    /// <param name="loop">Whether the animation should loop.</param>
    /// <param name="delay">The delay between animation loops.</param>
    /// <param name="playImmediately">Whether to start the animation immediately.</param>
